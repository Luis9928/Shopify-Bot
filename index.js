...
$("#tasksMenu").click(function(){
    $("#mainPage").load("tasks.html #mainPage > *", function(eventData){
...
$("#profilesMenu").click(function(){
    $("#mainPage").load("profiles.html #mainPage > *", function(eventData){
	    $.getScript('profiles.js', function(){
	    });
    });

})

$("#proxiesMenu").click(function(){
    $("#mainPage").load("proxies.html #mainPage > *", function(eventData){
	    $.getScript('proxies.js', function(){
	    });
    });
